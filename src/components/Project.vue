            ...
            <div class="container">
              <div class="row justify-content-center">
                <div class="col-lg-8">
                  ...
                  <img class="img-fluid rounded mb-5" v-if="index === 0" src="/src/assets/images/project/01.png" v-bind:alt="item.id">
                  <img class="img-fluid rounded mb-5" v-if="index === 1" src="/src/assets/images/project/02.png" v-bind:alt="item.id">
                  <img class="img-fluid rounded mb-5" v-if="index === 2" src="/src/assets/images/project/03.png" v-bind:alt="item.id">
                  <img class="img-fluid rounded mb-5" v-if="index === 3" src="/src/assets/images/project/04.png" v-bind:alt="item.id">
                  <img class="img-fluid rounded mb-5" v-if="index === 4" src="/src/assets/images/project/05.png" v-bind:alt="item.id">
                  <img class="img-fluid rounded mb-5" v-if="index === 5" src="/src/assets/images/project/06.png" v-bind:alt="item.id">
